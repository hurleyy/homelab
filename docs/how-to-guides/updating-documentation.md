...
The website is generated using [Material for MkDocs](https://squidfunk.github.io/mkdocs-material) and can be viewed at [homelab.hurley.dev](https://homelab.hurley.dev).
...
<!-- - Find the TXT record for `homelab.hurley.dev` and switch the `ownerID` between `homelab` and `horus` -->
